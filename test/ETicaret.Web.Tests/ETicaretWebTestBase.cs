...
{
    public abstract class ETicaretWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ETicaretWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ETicaretWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ETicaretDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ETicaretDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ETicaretDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ETicaretDbContext, Task<T>> func)
        {
            T result;
