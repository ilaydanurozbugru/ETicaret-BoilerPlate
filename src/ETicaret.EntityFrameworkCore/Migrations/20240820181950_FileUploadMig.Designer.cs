...
namespace ETicaret.Migrations
{
    ...
    [Migration("20240820181950_FileUploadMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaret.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ETicaret.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ETicaret.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ETicaret.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ETicaret.Storage.BinaryObject", "BinaryObject")
                        .WithMany()
