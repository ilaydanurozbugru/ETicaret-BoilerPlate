...
using ETicaret.Web.Models.Account;
using ETicaret.Web.Views.Shared.Components.TenantChange;

namespace ETicaret.Web.Controllers
{
    public class AccountController : ETicaretControllerBase
    {
        ...
        public async Task<ActionResult> Logout()
        {
            ...
            return RedirectToAction("Index" ,"Home"); //Anasayfaya yönlerdime
        }
